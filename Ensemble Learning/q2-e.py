...
def main():
    ...
    print("Average Bias (Random Forest):",avg_bagged_tree_bias)
    print("Average Variance (Random Forest):",avg_bagged_tree_variance)
    print("Average General Squared Error (Random Forest):", avg_bagged_tree_general_error)

    # Save the output to a text file
    output_file_path = utilities.results_path + "q2e_result.txt"
    with open(output_file_path, "w") as f:
        ...
        f.write(f"Average Bias (Random Forest): {avg_bagged_tree_bias}\n")
        f.write(f"Average Variance (Random Forest): {avg_bagged_tree_variance}\n")
        f.write(f"Average General Squared Error (Random Forest): {avg_bagged_tree_general_error}\n")

    print("Results saved to", output_file_path)

    print("Finished Q2-E tests...")
    return 0
